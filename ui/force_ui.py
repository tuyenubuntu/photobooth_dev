...
"")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Force DO", None))
        self.label_forcewindow.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:700;\">Force DO</span></p></body></html>", None))
        self.label_force_laser.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:16pt;\">Signal for laser machine</span></p></body></html>", None))
        ...
        self.label_force_oil.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:16pt;\">Signal for oildipping machine</span></p></body></html>", None))
